...
export const UNICODE_SPACE_CHARACTERS_REGEX = new RegExp(
  `[${UNICODE_SPACE_CHARACTERS.join("")}]+`,
  "g"
);
...
export const DISALLOWED_CHARACTERS_REGEX = new RegExp(
  `[${[...UNICODE_SPACE_CHARACTERS, ...COMBINED_CHARACTERS].join("")}]`,
  "g"
);

export const BAD_WORDS_REGEX =
